...
public class Config extends AbstractConfig {
    ...
    public final String redisUrl = this.get("redis-url", "0@127.0.0.1:6379");
    public final String redisUser = this.get("redis-user", "");
    public final String redisPassword = this.get("redis-password", "");
